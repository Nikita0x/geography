      ...
      child: SafeArea(
        child: Stack(
          children: [
            ...
            Align(
              alignment: Alignment(0.8, 0.1),
              child: Container(color: Colors.cyanAccent, width: 50, height: 50),
            ),
            Align(
              alignment: Alignment(0.6, 0.2),
              child: Container(
            ...
            Align(
              alignment: Alignment(0.2, 0.4),
              child: Container(color: Colors.pinkAccent, width: 50, height: 50),
            ),
            Align(
              alignment: Alignment(0, 0.5),
              child: Container(color: Colors.black, width: 50, height: 50),
            ...
            Align(
              ...
              child: Container(color: Colors.redAccent, width: 50, height: 50),
            ),
            Align(
