...
class CapitalsGuessCountryFromCapitalScreen extends StatefulWidget {
  const CapitalsGuessCountryFromCapitalScreen({super.key});

  @override
  State<CapitalsGuessCountryFromCapitalScreen> createState() =>
      _CapitalsGuessCountryFromCapitalScreenState();
}

class _CapitalsGuessCountryFromCapitalScreenState
    extends State<CapitalsGuessCountryFromCapitalScreen>
    with SignalsMixin {
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      navigationBar: const CupertinoNavigationBar(
        middle: Text('Guess Country from Capital'),
      ),
      child: SafeArea(
        child: Stack(
          children: [
